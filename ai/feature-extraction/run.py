...
from model import prepare_features, train_model, iterative_shap_train
...
"""
    ...
    for run in range(2):
        ...
        for i in range(epochs):
            ...
            df_importance = feature_importance.rename(
        ...
        avg_importances = all_importances.groupby(
            'feature')['importance'].mean().reset_index()
        avg_importances = avg_importances.sort_values(
