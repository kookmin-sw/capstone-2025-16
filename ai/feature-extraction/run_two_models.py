...
from model import prepare_two_features, train_model, iterative_shap_train, shap_visualization, predict_cohort_probability
  ...
  eligible_patients AS (
    ...
    for run in range(2):
        ...
        for i in range(epochs):
            ...
            X_train, X_test, y_train, y_test = train_test_split(X_procedure, y_proc, test_size=0.2, random_state=i)
            ...
            X_train, X_test, y_train, y_test = train_test_split(X_condition, y_cond, test_size=0.2, random_state=i)
