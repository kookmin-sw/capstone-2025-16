...
<div class="flex flex-col w-full gap-y-8">
	...
	<div class="flex flex-col gap-y-2 w-full">
		<span class="text-left">First visit record of the patient</span>
		{#if first}
	...
	<!-- Age at Visit -->
	<div class="flex flex-col gap-y-2 w-full">
		<p>Age at visit start:</p>
		<NumberOperator id="age-at-visit" on:value={({ detail }) => (age = detail)} />
	</div>
	...
	<!-- Visit Length -->
	<div class="flex flex-col gap-y-2 w-full">
		<p>Visit Length (days):</p>
		<NumberOperator id="visit-length" on:value={({ detail }) => (length = detail)} />
	</div>
	...
	<div class="flex flex-col gap-y-2 w-full">
		...
		<NumberOperator id="place-of-service" on:value={({ detail }) => (placeOfService = detail)} />
	</div>
</div> 