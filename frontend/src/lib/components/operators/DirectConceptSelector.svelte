...
<div class="relative w-full">
	...
	{#if showSearch}
		<div
			class="absolute z-10 mt-1 w-full origin-top-right rounded-lg bg-white p-3 shadow-lg ring-1 ring-black ring-opacity-5"
		>
			...
			{#if selectedConcept}
				<div class="mb-3">
					...
					<div
						class="max-h-28 space-y-1 overflow-y-auto rounded-md border border-gray-200 bg-gray-50 p-2"
					>
						<div
			...
			{#if searchResults.length > 0}
				<div>
					...
					<div
						class="max-h-40 space-y-1 overflow-y-auto rounded-md border border-gray-200 bg-white p-2"
					>
