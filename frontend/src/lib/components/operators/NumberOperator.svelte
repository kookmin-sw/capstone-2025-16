				...
				{#if isMultipleMode[type]}
					...
					<div class="space-y-3">
						<div class="flex items-center space-x-2">
							<input
								type="number"
								class="w-32 rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm shadow-sm transition-all focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
